...
def read_iemocap_mocap():
    ...
    for session in sessions:
        ...
        path_to_transcriptions_to_align = data_path + session + '/sentences/ForcedAlignment/'
        ...
        for f in files:       
            ...
            transcriptions = get_transcriptions_align(path_to_transcriptions, f + '.txt',
...
import pickle
with open('./'+'data_collected.pickle', 'wb') as handle:
